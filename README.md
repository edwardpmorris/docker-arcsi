...
To use the image, either pull the latest trusted build from https://registry.hub.docker.com/u/neteler/arcsi/ by doing this:

`docker pull neteler/arcsi`

or build the image yourself like this:

`docker build -t neteler/arcsi https://github.com/neteler/docker-arcsi`
...
`docker run -t neteler/arcsi arcsi.py -h`
